...
export default function TransactionHistory() {
  ...
  return (
    <div className="mx-auto max-w-[1200px] space-y-6">
      <div className="sticky top-[-1rem] z-30 -mx-4 flex flex-col gap-4 border-b border-border bg-canvas px-4 pb-5 pt-3 shadow-[0_3px_0_rgba(231,228,220,0.75)] sm:-mx-5 sm:px-5 sm:top-[-1.25rem] lg:-mx-8 lg:top-[-2rem] lg:flex-row lg:items-end lg:justify-between lg:px-8">
        <div>
