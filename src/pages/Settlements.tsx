...
export default function Settlements() {
  ...
  return <div className="space-y-6">
    <header className="sticky top-[-1rem] z-30 -mx-4 -mt-4 flex min-h-[9rem] flex-col gap-4 bg-ink px-4 py-5 text-white shadow-[0_3px_0_rgba(32,42,46,0.2)] sm:top-[-1.25rem] sm:-mx-5 sm:-mt-5 sm:px-5 lg:top-[-2rem] lg:-mx-8 lg:-mt-8 lg:min-h-[13.5rem] lg:flex-row lg:items-end lg:justify-between lg:px-8 lg:py-6">
      <div>
